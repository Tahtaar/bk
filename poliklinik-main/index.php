...
<div class="container-fluid flex flex-col justify-center items-center text-white p-5"
     style="height: 400px; background-image: url(); background-size: cover; background-position: center; position: relative;">
    ...
    <div class="container">
        ...
        <div class="testimonial-card my-4">
            <div class="card">
                <div class="card-content">
                    <div class="img-box">
                        <img src="assets/images/gojo.jpg" alt="Client 1">
                    </div>
                    <div class="text-content">
                        <h6>Gojo</h6>
                        <p class="location">Semarang</p>
                        <p class="testimonial-text">Mantap kaliii!!!</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="testimonial-card my-4">
            <div class="card">
                <div class="card-content">
                    <div class="img-box">
                        <img src="assets/images/sukuna.jpg" alt="Client 2">
                    </div>
                    <div class="text-content">
                        <h6>Sukuna</h6>
                        <p class="location">Semarang</p>
